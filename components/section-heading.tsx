    ...
    <div className="text-center space-y-4">
      ...
      >
        <div className="inline-block">
          <div className="relative px-6 py-3 text-sm font-medium rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-2">
      ...
      <motion.div
        className="w-24 h-1.5 bg-gradient-to-r from-yellow-500 to-red-500 rounded-full mx-auto mt-6"
