...
export function FloatingNav() {
  ...
  return (
    <>
      <motion.div
        className={`fixed top-6 right-4 md:right-28 z-50 ${isVisible ? "opacity-100" : "opacity-0 pointer-events-none"}`}
        initial={{ y: -100 }}
      ...
      >
        <div className="relative px-4 py-3 rounded-full bg-zinc-800/80 backdrop-blur-md border border-zinc-700/50 shadow-lg">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-yellow-500/20 to-red-500/20 rounded-full blur opacity-50"></div>
